...
const FilterWithStatusAndNumber = (props) => {
  const {
    onFilter,
    onReset,
    onFilterChange,
      ...
      <div className="col-xs-12 col-lg-12">
        <div className="card">
          <div className="card-body">
            ...
            >
              <div className="row">
                <div className="col-xs-12 col-lg-5 mt-3">
                ...
                <div className="col-xs-12 col-lg-3 mt-3">
                  <Form.Item name="id">
                    <Input
                      placeholder={intl.formatMessage(idPlaceHolder)}
                      prefix={
                        <SearchOutlined className="site-form-item-icon" />
                      }
                    />
...
export default injectIntl(FilterWithStatusAndNumber);
